                    ...
                    <div class="products">
                        ...
                        <div class="product">
                            ...
                            <div class="product-info text-left">
                                <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en) }}">@if(session()->get('language') == 'lithuanian') {{ $product->product_short_dic_lith}} @else {{ $product->product_short_dic_en}} @endif</a></h3>
                                <div class="rating rateit-small"></div>
