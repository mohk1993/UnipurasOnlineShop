            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#"><i class="icon fa fa-heart"></i>@if(session()->get('language') == 'lithuanian') Pageidavimų sąrašas @else My Wishlist @endif </a></li>
                        <li><a href="#"><i class="icon fa fa-shopping-cart"></i>@if(session()->get('language') == 'lithuanian') Mano krepšelis @else My Cart @endif </a></li>
                        <li><a href="#"><i class="icon fa fa-check"></i>@if(session()->get('language') == 'lithuanian') Atsiskaitymas @else Checkout @endif </a></li>
                        <li>
                            @auth
